...
class NavigationIncomeCategoryPage extends StatefulWidget {
  const NavigationIncomeCategoryPage({super.key});

  @override
  State<NavigationIncomeCategoryPage> createState() => _NavigationIncomeCategoryPageState();
}

class _NavigationIncomeCategoryPageState extends State<NavigationIncomeCategoryPage> {
